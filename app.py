...
Імпортуйте файл csv часового ряду сюди. Стовпці повинні мати позначки ds і y. Вхідними даними для Prophet завжди є фрейм даних із двома стовпцями: ds і y. 
        Стовпець ds (штамп дати) має мати формат, очікуваний Pandas, в ідеалі РРРР-ММ-ДД для дати або РРРР-ММ-ДД ГГ:ХХ:СС для позначки часу. 
